...
class TestDealService:
    ...
    @pytest.fixture
    def deal_service(self, mock_repo, mock_binance_client, mock_apikeys_service, mock_log_service):
        return DealService(
            repo=mock_repo,
    ...
    async def test_close_deal_success(self, deal_service, mock_repo):
        ...
        # Assert
        mock_repo.close_deal.assert_called_once_with(deal_id, exit_price, pnl)
        mock_session.commit.assert_called_once()
