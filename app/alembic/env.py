...
from models.trade_models import Deal, APIKeys, StrategyLog, StrategyConfig
from models.user_model import User, UserStrategyTemplate
...
# Для создания миграций используем offline режим
# Для применения - online режим
